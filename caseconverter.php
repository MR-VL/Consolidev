...
<body>
	...
	<textarea id="entry" name="entry" placeholder="Enter your text here" required>
	</textarea>
	...
	<textarea id="result" name="result"><?php if(isset($display)) echo htmlspecialchars($display); ?>
	</textarea>
